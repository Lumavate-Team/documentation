...
You will need to install `Python 3.1.1 or higher <https://www.python.org/downloads/>`_ in order to use the CLI. If you are using Windows, remember to click the “Add Python To Path” checkbox when installing Python.  
